    ...
    <div class="container">
        ...
        <el-dialog
            ...
            <el-form :model="editForm" :rules="editFormRules" ref="editForm">
                ...
                <el-form-item label="Catelog Code"  prop="catelogCode" label-width="150px">
                    <el-input v-model="editForm.catelogCode" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="Catelog Name"  prop="catelogName" label-width="150px">
                    <el-input v-model="editForm.catelogName" autocomplete="off"></el-input>
                </el-form-item>
...
export default class Department extends Vue {
    ...
    submitForm(formName: string) {
        ...
        validData.validate((valid: any) => {
            if (valid) {
                ...
                axios.post('/base/promotion-catelog/' + (this.editForm.id ? 'update' : 'create'), this.editForm)
                    .then((res: any) => {
                        this.deptAllList()
                        this.$notify({
                            title: 'Msg',
    ...
    editHandle(id: number) {
        axios.get('/base/promotion-catelog/' + id).then((res: any) => {
    ...
    delItem(id: number) {
        axios.delete('/base/promotion-catelog/void/'+ id).then((res: any) => {
            this.deptAllList()
            this.$notify({
                title: '',
                showClose: true,
